...
def main(page: ft.Page):
    ...
    def criar_aluno_click(e):
        ...
        if response.status_code == 200:
            aluno = response.json()
            create_result.value = f'Aluno criado com sucesso! Aluno: {aluno}'
        else:
    ...
    def consultar_progresso_click(e):
        ...
        if response.status_code == 200:
            ...
            progress_result.value = f'Erro ao consultar progresso: {response.text}'
    ...
    def atualizar_aluno_click(e):
        ...
        if not aluno_id:
            ...
            if response.status_code == 200:
                aluno = response.json()
                update_result.value = f'Aluno atualizado com sucesso! Aluno: {aluno}'
            else:
